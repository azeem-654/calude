...
/**
 * What a browser context needs to boot into that workspace.
 *
 * Returned as `{ script, data }` rather than run here, because Playwright
 * serialises the function and its argument across into the page — a closure
 * over module scope would arrive undefined.
 */
